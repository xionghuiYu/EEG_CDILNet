...
from AMSINet import AMSINet
from MIEEGNet import MIEEGNet
from EEG_CDILNet_tiny import EEG_CDILNet
#from EEG_CDILNet_covd1_v2 import EEG_CDILNet
#from EEG_CDILNet_tiny_flatten import EEG_CDILNet
...
def train(name, Parms, dataSetType = 0, records = True, optimalPra = True,solo = True, soloSub = 14):
    """
    ...
    solo - Whether to train on a single subject,Whether to train on a single subject, and if false, train on all subjects
...
if __name__ == "__main__":
    ...
    if GridCV:
        ...
        totalParamenter1 = [[24,32], [48,64], [2,4], [0.5], [24,32], [2,3], [3],[8]]
        temp = []
